# Guia Visual: Dashboard SaaS Premium

Este guia documenta as decisões de design da **Plataforma de Governança Intersetorial de PTS**.
...
### 2. Formulários (PTS / Pacientes / Unidades)
